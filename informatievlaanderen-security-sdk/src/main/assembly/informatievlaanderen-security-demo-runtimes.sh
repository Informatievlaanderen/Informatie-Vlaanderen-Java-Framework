#!/bin/bash
echo "Informatie Vlaanderen Java Security JAX-WS runtime tests..."
...
function JAXWS_RI_ {
	...
	java -cp $CLASSPATH be.vlaanderen.informatievlaanderen.security.demo.CLIMain $2 $3 $4 $5 > /dev/null 2>&1
	echo "		$?"
}
...
function JAXWS_DEFAULT {
	...
	java -cp $CLASSPATH be.vlaanderen.informatievlaanderen.security.demo.CLIMain $1 $2 $3 $4 > /dev/null 2>&1
	echo "		$?"
}
...
function AXIS2_ {
	...
	$AXIS2_HOME/bin/axis2.sh -cp $CLASSPATH be.vlaanderen.informatievlaanderen.security.demo.CLIMain $2 $3 $4 $5 > /dev/null 2>&1
	echo "		$?"
}
