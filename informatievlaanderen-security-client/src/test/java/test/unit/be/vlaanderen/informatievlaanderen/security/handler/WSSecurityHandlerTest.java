...
package test.unit.be.vlaanderen.informatievlaanderen.security.handler;
...
import test.unit.be.vlaanderen.informatievlaanderen.security.client.TestUtils;
...
public class WSSecurityHandlerTest {
	...
	public void testWSSecurityWithoutInitialHeader() throws Exception {
		...
		EasyMock.expect(
				mockContext
						.get("be.vlaanderen.informatievlaanderen.security.handler.WSSecurityHandler.token"))
				.andStubReturn(null);
		EasyMock.expect(
				mockContext
						.get("be.vlaanderen.informatievlaanderen.security.handler.WSSecurityHandler.username"))
				.andStubReturn("username");
		EasyMock.expect(
				mockContext
						.get("be.vlaanderen.informatievlaanderen.security.handler.WSSecurityHandler.password"))
				.andStubReturn("password");
		EasyMock.expect(
				mockContext
						.get("be.vlaanderen.informatievlaanderen.security.handler.WSSecurityHandler.key"))
				.andStubReturn(null);
