...
/**
 * JAX-WS based Informatie Vlaanderen IP-STS WS-Trust client. Via this client one can retrieve
 ...
 * the Informatie Vlaanderen IP-STS and thus will most likely not work for other IP-STS
 * configurations.
 * 
...
//		SecurityToken securityToken = getSecurityToken(certificate,
//				privateKey);
//		return securityToken;
//	}	
//
//	private SecurityToken getSecurityToken(X509Certificate certificate, PrivateKey privateKey) {
