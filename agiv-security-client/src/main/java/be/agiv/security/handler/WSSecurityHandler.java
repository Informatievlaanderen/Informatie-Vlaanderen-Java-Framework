 ...
 * different AGIV web services.
 * 
 * @author Frank Cornelis
 * 
 */
public class WSSecurityHandler implements AGIVSOAPHandler {
	...
	private void addUsernamePassword(SOAPMessageContext context,
		...
		// WSConstants.PASSWORD_DIGEST is not supported by AGIV IP-STS
	...
	public Set<QName> getHeaders() {
		...
		headers.add(new QName(
				be.agiv.security.client.WSConstants.WS_SECURITY_NAMESPACE,
				"Security"));
		return headers;
	}
